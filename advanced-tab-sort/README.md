...
## What’s included
- `advanced-tab-sort.uc.js` — core logic and provider adapters.
- `preferences.json` — defaults and settings schema for Sine.
- `userChrome.css` / `theme.json` — placeholders if you want styling tweaks.
